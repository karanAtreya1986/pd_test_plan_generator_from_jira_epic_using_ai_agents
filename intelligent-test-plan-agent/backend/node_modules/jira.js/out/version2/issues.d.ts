...
export declare class Issues {
     ...
     */
    archiveIssuesAsync<T = unknown>(parameters: Parameters.ArchiveIssuesAsync, callback: Callback<T>): Promise<void>;
    /**
     * Enables admins to archive up to 100,000 issues in a single request using JQL, returning the URL to check the status
     * of the submitted request.
     *
     ...
     * **Rate limiting:** Only a single request per user can be active at any given time.
     */
    archiveIssuesAsync<T = unknown>(parameters: Parameters.ArchiveIssuesAsync, callback?: never): Promise<T>;
    /**
